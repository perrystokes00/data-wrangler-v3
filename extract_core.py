    ...
    try:
        if fext == ".pdf":
            ...
            try:
                ...
                from modules.pdf_survey_catalog import resolve_pdf_fields
            ...
            try:
                import re as _re
                from segy_header import read_segy_header
            ...
            _classify_csv = None
            try:
                from modules.csv_catalog import classify_csv as _classify_csv
