...
def _load_schema():
    ...
    if jpath.exists():
        import json as _j
        from modules.schema import load_schema_from_dict
...
def _detect_fingerprint(file_path, target_table, cache):
    ...
    from modules.mapping import mapping_fingerprint
    try:
...
def watch_loop(engine, ppdm_schema, poll=30):
    from modules.mapping import _load_cache as _lc
