...
# 4) guard _th.start() — the detached run sets _th=None (no thread to start)
old4 = '''            st.session_state["fp_report_run"] = fp_report.strip() or r"C:\\Bulk\\reports"
            _th.start()'''
new4 = '''            st.session_state["fp_report_run"] = fp_report.strip() or r"C:\\Bulk\\reports"
