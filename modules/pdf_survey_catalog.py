...
INFO_PATTERNS = {
    ...
    "well_name": [
        ...
        r'(?:Well\s+Name)[:\s]+([A-Za-z0-9 #\-/]+?)(?:\n|$)',
        r'(?:WELL)[:\s]+([A-Z0-9 #\-/]+?)(?:\n|$)',
    ],
    "operator": [
        r'(?:OPERATOR|COMPANY|OPERATED\s+BY)[:\s]+([A-Za-z0-9 &.,]+?)(?:\n|\r|$)',
        r'Operator[:\s]+([A-Za-z0-9 &.,]+?)(?:\n|\r|$)',
    ],
    "field": [
    ...
    try:
        with pdfplumber.open(file_path) as pdf:
            ...
            _specific = [
                ...
                (RT_PETRO,    ["PETROPHYSICAL", "LOG INTERPRETATION",
                                "WELL LOG ANALYSIS", "NEUTRON", "GAMMA RAY"]),
