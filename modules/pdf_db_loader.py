...
def load_well_test(engine, dialect: str, well_info: dict,
    ...
    try:
        from modules.pdf_survey_catalog import extract_well_test
    except ImportError:
        from pdf_survey_catalog import extract_well_test
...
def load_directional_survey(engine, dialect: str, well_info: dict,
    ...
    """
    try:
        from modules.survey_loader import (
...
def load_scout(engine, dialect: str, well_info: dict,
    ...
    try:
        ...
        from pdf_survey_catalog import extract_scout_ticket
