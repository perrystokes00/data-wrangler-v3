...
try:
    import modules.dv_catalog_adapter as _adapter
...
def _render_pdf_panel(engine, file_path: str, inv_id: str, idx: int):
    ...
    if cache_key not in st.session_state:
        with st.spinner("🔍 Extracting data from PDF..."):
            try:
                from modules.file_summarizer import summarize_file
...
def _render_inspect(engine):
    ...
    if ext == ".pdf":
        ...
        try:
            from page_file_workbench import render_workbench
