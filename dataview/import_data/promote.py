...
def promote_server(
    ...
    try:
        ...
        # ── Dialect branch ───────────────────────────────────────────
        from dataview.core.db import get_dialect as _ps_gd
...
def promote_merge(
    ...
    try:
        from sqlalchemy import text
        from dataview.core.db import get_dialect as _mg_gd
...
if __name__ == "__main__":
    ...
    from dataview.core.validate import ValidationReport
    ...
    from dataview.core.validate import ValidationIssue
    ...
    from dataview.import_data.mapping import ColumnMapping
