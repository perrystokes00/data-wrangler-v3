...
def render(S, st):
    ...
    from dataview.core.fk import (check_fk_violations, get_reference_table_context,
    ...
    try:
        if _use_server:
            from dataview.core.fk import check_fk_violations_server
    ...
    if submitted:
        ...
        if any_change:
            ...
            try:
                from dataview.core.fk import clear_parent_values_cache
...
def _apply(S, violation, ctx, edited, src_col, pk_col, label_to_pk,
    ...
    from sqlalchemy import text
    from dataview.core.fk import insert_reference_rows
    ...
    if remaps:
        try:
            ...
            try:
                from dataview.reference_tables.value_standardize import upsert_value_map
