...
from ui_helpers import shdr, mrow
...
def _detect_fingerprint(file_path: str, target_table: str) -> tuple[str | None, int]:
    ...
    try:
        ...
        import csv as _csv
        from modules.mapping import mapping_fingerprint, _load_cache
        from modules.staging import _sanitize_col, _dedupe_cols
...
def _run_seed_job(job: dict, engine) -> dict:
    ...
    from modules.db import _detect_dialect as _dd
...
def run_job(job: dict, engine, ppdm_schema, progress_cb=None, cancel_flag=None) -> dict:
    ...
    from modules.normalize import normalize_server
    from modules.fk        import introspect_fk_constraints, check_fk_violations
    from modules.fk_entity import is_reference_table, build_fk_graph
    ...
    try:
        ...
        # ── Dialect detection ────────────────────────────────────────────
        from modules.db import get_dialect as _bulk_gd
        _d         = _bulk_gd(engine)
        ...
        from modules.mapping import _load_cache as _lc2
        ...
        try:
            ...
            from modules.mapping import build_transform_sql as _s5bts
        ...
        try:
            ...
            if _ppdm_schema:
                from modules.fk import FKConstraint, FKColumn
        ...
        _cb("Validate", 70)
        from modules.validate import validate_server as _validate_server
...
def render(S):
    ...
    with tab_queue:
        ...
        if st.button("🔗 Build FK queue", type="primary",
            ...
            if _bfk_tbl == "— select —":
                ...
                _dep_ok    = False
                try:
                    from modules.mapping import _load_cache, mapping_fingerprint
                    ...
                    try:
                        ...
                        for _csv_f in sorted(pathlib.Path(_bfk_folder).glob("*.csv")):
                            ...
                            try:
                                ...
                                from modules.staging import _sanitize_col, _dedupe_cols
                                from modules.mapping import mapping_fingerprint as _mfp2
    ...
    with tab_maint:
        ...
        from modules.mapping import _load_cache as _lc_maint, _save_cache as _sc_maint
            ...
            for _wcsv in _all_watch_csvs:
                try:
                    ...
                    while _wcols and _wcols[-1] in ('', 'col'):
                        _wcols.pop()
                    from modules.mapping import mapping_fingerprint as _mfp
