...
def _cached_value_map(_engine, _ver):
    ...
    from modules.value_standardize import fetch_value_map
...
def _render_value_standardization(S):
    ...
    with st.expander("🔤 Value Standardization · manage canonical mappings",
        ...
        try:
            from modules.value_standardize import fetch_value_map, upsert_value_map
            _seg_f = _t_now()
        ...
        if df is None or not S.col_mapping:
            ...
            if S.engine and not S.demo and not S.fk_checked:
                with st.spinner("Standardizing values against the database…"):
                    try:
                        from modules.value_standardize import (
              ...
              with st.spinner("Checking foreign keys against the database…"):
                try:
                    ...
                    try:
                        ...
                        if S.engine and not S.demo:
                            from modules.fk_entity import ServerFrame as _ServerFrame
            ...
            _t_panel = _t_now()
            try:
                from modules.fk_resolve_panel import render as _render_fk_panel
                    ...
                    if st.button(
                        ...
                        try:
                            with st.spinner("Promoting..."):
                                ...
                                if not S.demo:
                                    try:
                                        from modules.entity_map_seed import (
